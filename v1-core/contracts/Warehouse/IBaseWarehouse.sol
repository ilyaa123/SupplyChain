...
interface IBaseWarehouse is IBaseWarehouseStorage {
    ...
    function initialize(uint256 _id, address _supplyChain, address _productRegistry, address _newOwner, string memory _name, string memory _url, int256 _lat, int256 _lon) external;
